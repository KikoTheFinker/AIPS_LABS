...
class BTree<E> {
    ...
    public void PreorderNonRecursive() {
        Stack<BNode<E>> stack = new ArrayStack<>(50);
        BNode<E> temp = root;
        ...
        while (!stack.isEmpty()){
            if (temp.left != null && !list.contains(temp.left)){
            ...
            else if(temp.right != null && !list.contains(temp.right)){
                ...
                temp = stack.pop();
                if(temp.info.equals(root.info) && temp.right!=null && !list.contains(temp.right))
                {
                    stack.push(temp);
                }
            }
        }
        for (BNode<E> ebNode : list) {
            System.out.printf(ebNode.info + " ");
        }
    }
